...
posicao = st.number_input('Posição no último ranking', format="%f")
...
faturamento = st.number_input('Faturamento esperado no mês', format="%.0f")
...
incremento = st.number_input('Incremento de PL esperado no mês', format="%.0f")
...
saldo = st.number_input('Saldo de HC esperado no mês', format="%f")
